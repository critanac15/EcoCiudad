...
<body >
    <header class="xl:grid xl:grid-cols-7 bg-[#000000] text-white xl:py-5 xl:px-40 ">
        ...
        <nav class="xl:flex xl:gap-4 xl:col-span-5 justify-center xl:text-lg">
            ...
            <a class="xl:px-3 xl:py-2 xl:rounded-xl hover:underline xl:hover:underline-offset-4 duration-200 xl:hover:scale-115 hover:outline-[#6b878d] hover:cursor-pointer" href="{{route('contacto')}}">Contacto</a>
        </nav>
    ...
    <main>
        <div class="flex justify-center items-center xl:pt-24 ">
            <form action="{{route('soporteAyuda')}}" role="search" class="flex items-center shadow-2xl shadow-black/8 border border-gray-200 rounded-2xl">
                <div class="flex items-center bg-white  rounded-2xl xl:w-96 ">
                    ...
                    <button type="submit" class="pr-3 pl-1 cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="xl:size-6">
        ...
        <div class="xl:grid xl:grid-cols-3  xl:gap-10 xl:px-40 xl:py-20 font-light">
        ...
        <div class="flex justify-center items-center xl:py-20">
            <div>
                <h2 class="xl:text-2xl font-light">¿No encontrase solución?</h2>
                <div class="flex justify-center items-center">

                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="xl:size-16 xl:hover:scale-105" viewBox="0 0 48 48">
    ...
    <footer class="bg-black xl:grid xl:grid-cols-4 text-white xl:py-10 xl:px-40 xl:gap-10">
        ...
        <div class="col-span-2 xl:flex xl:items-center">
            <div>
                ...
                <p>EcoCiudad es una iniciativa tecnológica que busca devolverle la limpieza y el orden a Arequipa, uniendo a vecinos y autoridades mediante la gestión inteligente de residuos.</p>
            </div>
